	...
	<head>
				...
				function loadXQ(){
					...
					$.ajax({
						...
						success:function(d){
							if(d.status == 0){
								var mission = d.data;
									var mname = mission.mname;
									var cname = mission.cname;
									var mstime = mission.mstime;
									var metime = mission.metime;
									var mtime = mission.mtime;
									var uid = mission.uid;
									var cid = mission.cid;
									var fuid = mission.fuid;
									var clianxi = mission.clianxi;
									var mjieshao = mission.mjieshao;
									var speed = mission.speed;
		...
		function link(){
			 ...
			 if(a == true){
				 ...
				 $.ajax({
					 url:path + "/updateRenwu.do",
						type:"post",
						data:{"mid":mid,"mname":mname,"mtime":mtime,"mstime":mstime,"metime":metime,"cid":cid,"uid":fuid,"fuid":uid,"mjieshao":mjieshao,"speed":speed},
						dataType:"json",
						success:function(d){
							alert("修改成功");
			...
			<TD width="100%">
				...
				<legend>添加任务</legend>
					  ...
					  <tr>
					    ...
					    <td width="27%"><input name="Input22" id="mtime" class="text" style="width:154px" /></td>天
					    </tr>
					  <tr>
					  ...
					  <tr>
					    ...
					    <td colspan="3"><textarea id="mjieshao" name="textarea" rows="5" cols="80"></textarea></td>
					    </tr>
					  </table>
			 <br />
				</fieldset>			</TD>
